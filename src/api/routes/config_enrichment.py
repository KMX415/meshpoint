...
def enrich_config_payload(
    ...
    *,
    ...
    if provisioned(cfg):
        base["platform_ui"] = {"variant": "pimesh", "protocol_switch": True}
        base["device"].update(radio_hat=device.radio_hat, radio_protocol=device.radio_protocol)
    elif platform == "node":
    ...
    base["capture"] = {
        ...
        "meshcore_usb": {
            ...
            "connection_type": mc_usb.connection_type,
        },
